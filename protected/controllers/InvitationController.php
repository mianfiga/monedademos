...
class InvitationController extends Controller {
    ...
    public function accessRules() {
        $users = User::model()->findAll('abilities like \'%'. User::ABILITY_INVITE . '%\'');
        $can_invite = array();
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('Invitation', array(
            'criteria' => array(
                'condition' => "user_id = " . Yii::app()->user->getId() . " AND created > '" . date('Y-m-d H:i:s', strtotime("-" . Invitation::EXPIRATION . " days")) . "'",
                'order' => 'id ASC')
        ));
