...
// if AJAX request (triggered by deletion via admin grid view), we should not redirect the browser
    ...
    public function actionUnsubscribe($e_id, $n_id, $m) {
        ...
        $notification_conf = NotificationConfiguration::model()->findByPk(
                array(
                    'entity_id' => $e_id,
        ...
        if (!$notification_conf) {
            ...
            $notification_conf->setIsNewRecord(true);
            $notification_conf->entity_id = $e_id;
        }
        $notification_conf->mailmode = NotificationConfiguration::MAILMODE_NONE;
        $notification_conf->save();
        $this->render('unsubscribe', array(
            'model' => $notification_conf,
        ));
    }
