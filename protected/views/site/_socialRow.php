<div class="row">
    ...
    <div class="small-12 large-4 columns hide-for-small">
        <div class="list_top"><a href="https://blog.monedademos.es">Blog</a></div>
        <div id="hlrpsa" class="list_body">
            <script src="https://helplogger.googlecode.com/svn/trunk/recent-posts-with-snippets.js">
            </script>
            <script>
                var numposts = 10;var showpostdate = true;var showpostsummary = true;var numchars = 100;var standardstyling = true;
            </script>
            <script src="https://monedademos.blogspot.com/feeds/posts/default?orderby=published&amp;alt=json-in-script&amp;callback=showrecentposts">
            </script></div>
        <div id="rpdr" style="font-family: arial, sans-serif; font-size: 9px;">
            <a href="https://helplogger.blogspot.com/2012/04/recent-posts-widget-for-bloggerblogspot.html" target="_blank" title="Grab this Recent Posts Widget">Recent Posts Widget</a> by <a href="https://helplogger.blogspot.com" title="Recent Posts Widget">Helplogger</a></div>
