<div class="view">
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('ability_title')); ?>:</b>
	<?php echo CHtml::encode($data->ability_title); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('ability_text')); ?>:</b>
	<?php echo CHtml::encode($data->ability_text); ?>
	<br />
