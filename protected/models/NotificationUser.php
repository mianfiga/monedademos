 ...
 * @property User $user
 */
class NotificationUser extends NotificationUserBase
{
...
//      'configuration' => array(self::HAVE_ONE, 'NotificationConfiguration', array('user_id' => 'user_id','notification_id'=>'notification_id')),
		);
	}
