 ...
 * @property TribeBalance[] $tribeBalances
 * @property TribeBalance[] $tribeBalances1
 * @property TribeMigration[] $tribeMigrations
 * @property Period[] $periods
 * @property Record[] $records
 * @property Rule[] $rules
 */
class TribeBase extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return TribeBase the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'entities' => array(self::HAS_MANY, 'Entity', 'tribe_id'),
			'createdBy' => array(self::BELONGS_TO, 'Entity', 'created_by'),
			'group' => array(self::BELONGS_TO, 'TribeGroup', 'group_id'),
			'tribeBalances' => array(self::HAS_MANY, 'TribeBalance', 'from_id'),
			'tribeBalances1' => array(self::HAS_MANY, 'TribeBalance', 'to_id'),
			'tribeMigrations' => array(self::HAS_MANY, 'TribeMigration', 'to_id'),
			'periods' => array(self::HAS_MANY, 'Period', 'tribe_id'),
			'records' => array(self::HAS_MANY, 'Record', 'tribe_id'),
			'rules' => array(self::HAS_MANY, 'Rule', 'tribe_id'),
		);
	}
